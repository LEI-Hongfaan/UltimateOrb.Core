...
namespace UltimateOrb.Numerics {
    ...
    /// are real numbers, and i is the imaginary unit, with the property i * i = -1.
    /// </summary>
    [Serializable]
    public readonly struct Complex :
        ...
        private readonly Vector128<double> m_value;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Complex(Vector128<double> value) {
            m_value = value;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Complex(double real, double imaginary) {
            m_value = Vector128.Create(real, imaginary);
        }
        ...
        public static Complex Conjugate(Complex value) {
            return new Complex(Vector128.Multiply(value.m_value, Vector128.Create(1.0, -1.0)));
        }
        ...
        */
        ...
        static bool INumberBase<Complex>.TryConvertToChecked<TOther>(Complex value, [MaybeNullWhen(false)] out TOther result) {
            ...
            if (typeof(TOther) == typeof(byte)) {
                ...
                Utilities.ThrowHelper.ThrowOnNonZero(value.m_imaginary);
                if (value.m_imaginary != 0) {
                    ThrowHelper.ThrowOverflowException();
                }
